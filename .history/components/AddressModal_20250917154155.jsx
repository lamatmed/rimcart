...
const AddressModal = ({ setShowAddressModal }) => {
 ...
 try {
      ...
      formData.append("email", productInfo.description);
      formData.append("street", productInfo.mrp);
      formData.append("city", productInfo.price);
      formData.append("state", productInfo.category);
