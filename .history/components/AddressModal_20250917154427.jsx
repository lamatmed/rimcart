...
const AddressModal = ({ setShowAddressModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("street", productInfo.street);
      formData.append("city", productInfo.city);
      formData.append("state", productInfo.state);
      formData.append("zip", productInfo.zip);
      formData.append("country", productInfo.country);
       formData.append("phone", productInfo.country);
