...
export async function POST(req) {
  try {
    ...
    const imageUrl = uploadResponse.url({
        ...
        transformation: [
          {
            format: 'webp', // Format optimal (webp si supporté)
            quality: 'autou',  // Qualité réduite à 80% pour optimisation
            width: '800',   // Redimensionnement à 800px de large
            height: '600',  // Redimensionnement à 600px de haut
            crop: 'limit'   // Maintien des proportions
          }],
    });
